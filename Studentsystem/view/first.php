           	...
           	<div class="top_menu row m0">
           		<div class="container">
					...
					<div class="float-right">
						...
						<a class="dn_btn" href="mailto:support@colorlib.com">YCT University.com</a>
					</div>
           		</div>	
           	</div>	
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.html">YCT University</a>
        				...
        				<div class="finance_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							<h5>Computer Science <br />Engineering</h5>
        						</div>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-3 col-sm-6">
        				<div class="finance_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							<h5>Mechanical<br />Engineering</h5>
        						</div>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-3 col-sm-6">
        				<div class="finance_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							<h5>Electronics & Communication <br />Engineering</h5>
        						</div>
        					</div>
        				</div>
        			</div>
...
Copyright &copy;<script>All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
