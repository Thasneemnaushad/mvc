  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item border-top" href="student_editsubjects.php">Add Students</a>
            <a class="collapse-item" href="student_viewsubjects.php">View Students</a>
    </div>
        </div>	
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
		 ...
		 <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
     <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item border-top" href="student_editsubjects.php">Add Results</a>
            <a class="collapse-item" href="student_viewsubjects.php">View Results</a>
    </div>
        </div>	
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="faculy_timetable.php">
